...
--
-- Client: 127.0.0.1
-- Généré le: Mar 24 Juin 2014 à 18:59
...
--
-- Structure de la table `jdev_assets`
--

CREATE TABLE IF NOT EXISTS `jdev_assets` (
...
--
-- Vider la table avant d'insérer `jdev_assets`
--

TRUNCATE TABLE `jdev_assets`;
--
-- Contenu de la table `jdev_assets`
--

INSERT INTO `jdev_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(29, 7, 14, 15, 2, 'com_contact.category.4', 'Contact principal', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
...
--
-- Structure de la table `jdev_associations`
--

CREATE TABLE IF NOT EXISTS `jdev_associations` (
...
--
-- Vider la table avant d'insérer `jdev_associations`
--

TRUNCATE TABLE `jdev_associations`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_banners`
--

CREATE TABLE IF NOT EXISTS `jdev_banners` (
...
--
-- Vider la table avant d'insérer `jdev_banners`
--

TRUNCATE TABLE `jdev_banners`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_banner_clients`
--

CREATE TABLE IF NOT EXISTS `jdev_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Vider la table avant d'insérer `jdev_banner_clients`
--

TRUNCATE TABLE `jdev_banner_clients`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `jdev_banner_tracks` (
...
--
-- Vider la table avant d'insérer `jdev_banner_tracks`
--

TRUNCATE TABLE `jdev_banner_tracks`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_categories`
--

CREATE TABLE IF NOT EXISTS `jdev_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_categories`
--

TRUNCATE TABLE `jdev_categories`;
--
-- Contenu de la table `jdev_categories`
--

INSERT INTO `jdev_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(4, 29, 1, 5, 6, 1, 'contact-principal', 'com_contact', 'Contact principal', 'contact-principal', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2010-06-28 13:27:57', 455, '2014-06-24 16:37:43', 0, '*'),
...
--
-- Structure de la table `jdev_contact_details`
--

CREATE TABLE IF NOT EXISTS `jdev_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Vider la table avant d'insérer `jdev_contact_details`
--

TRUNCATE TABLE `jdev_contact_details`;
--
-- Contenu de la table `jdev_contact_details`
--

INSERT INTO `jdev_contact_details` (`id`, `name`, `alias`, `con_position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `imagepos`, `email_to`, `default_con`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `user_id`, `catid`, `access`, `mobile`, `webpage`, `sortname1`, `sortname2`, `sortname3`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`) VALUES
(1, 'Contact', 'contact', '', '', '', '', '', '', '', '', '', '', NULL, 'charles@charlesen.fr', 0, 1, 0, '0000-00-00 00:00:00', 1, '{"show_contact_category":"","show_contact_list":"","presentation_style":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_profile":"","show_links":"","linka_name":"","linka":false,"linkb_name":"","linkb":false,"linkc_name":"","linkc":false,"linkd_name":"","linkd":false,"linke_name":"","linke":"","contact_layout":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":""}', 0, 4, 1, '', '', '', '', '', '*', '2014-06-24 16:38:39', 455, '', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_content`
--

CREATE TABLE IF NOT EXISTS `jdev_content` (
...
--
-- Vider la table avant d'insérer `jdev_content`
--

TRUNCATE TABLE `jdev_content`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `jdev_content_frontpage` (
...
--
-- Vider la table avant d'insérer `jdev_content_frontpage`
--

TRUNCATE TABLE `jdev_content_frontpage`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_content_rating`
--

CREATE TABLE IF NOT EXISTS `jdev_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Vider la table avant d'insérer `jdev_content_rating`
--

TRUNCATE TABLE `jdev_content_rating`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `jdev_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Vider la table avant d'insérer `jdev_core_log_searches`
--

TRUNCATE TABLE `jdev_core_log_searches`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_extensions`
--

CREATE TABLE IF NOT EXISTS `jdev_extensions` (
...
--
-- Vider la table avant d'insérer `jdev_extensions`
--

TRUNCATE TABLE `jdev_extensions`;
--
-- Contenu de la table `jdev_extensions`
--

INSERT INTO `jdev_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(603, 'French (fr-FR)', 'language', 'fr-FR', '', 1, 1, 0, 1, '{"legacy":false,"name":"French (fr-FR)","type":"language","creationDate":"01-03-2014","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2014 Open Source Matters & Joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.22.1","description":"French administrator language for Joomla 2.5","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(604, 'French (fr-FR)', 'language', 'fr-FR', '', 0, 1, 0, 1, '{"legacy":false,"name":"French (fr-FR)","type":"language","creationDate":"01-03-2014","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2014 Open Source Matters & joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.22.1","description":"French site language for Joomla 3.0","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'W°FAR', 'template', 'wfar', '', 0, 1, 1, 0, '{"legacy":false,"name":"W\\u00b0FAR","type":"template","creationDate":"23\\/06\\/2014","author":"Charles EDOU NZE","copyright":"Copyright (C) 2014 ch@rlesen. All rights reserved.","authorEmail":"charlesen@charlesen.fr","authorUrl":"http:\\/\\/charlesen.fr","version":"1.0.0","description":"World Forum For Animal rights (W\\u00b0FAR) template by ch@rlesen","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_filters`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_filters` (
...
--
-- Vider la table avant d'insérer `jdev_finder_filters`
--

TRUNCATE TABLE `jdev_finder_filters`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links` (
...
--
-- Vider la table avant d'insérer `jdev_finder_links`
--

TRUNCATE TABLE `jdev_finder_links`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms0` (
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms0`
--

TRUNCATE TABLE `jdev_finder_links_terms0`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms1`
--

TRUNCATE TABLE `jdev_finder_links_terms1`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms2`
--

TRUNCATE TABLE `jdev_finder_links_terms2`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms3`
--

TRUNCATE TABLE `jdev_finder_links_terms3`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms4`
--

TRUNCATE TABLE `jdev_finder_links_terms4`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms5`
--

TRUNCATE TABLE `jdev_finder_links_terms5`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms6`
--

TRUNCATE TABLE `jdev_finder_links_terms6`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms7`
--

TRUNCATE TABLE `jdev_finder_links_terms7`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms8`
--

TRUNCATE TABLE `jdev_finder_links_terms8`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_terms9`
--

TRUNCATE TABLE `jdev_finder_links_terms9`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termsa`
--

TRUNCATE TABLE `jdev_finder_links_termsa`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termsb`
--

TRUNCATE TABLE `jdev_finder_links_termsb`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termsc`
--

TRUNCATE TABLE `jdev_finder_links_termsc`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termsd`
--

TRUNCATE TABLE `jdev_finder_links_termsd`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termse`
--

TRUNCATE TABLE `jdev_finder_links_termse`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Vider la table avant d'insérer `jdev_finder_links_termsf`
--

TRUNCATE TABLE `jdev_finder_links_termsf`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Vider la table avant d'insérer `jdev_finder_taxonomy`
--

TRUNCATE TABLE `jdev_finder_taxonomy`;
--
-- Contenu de la table `jdev_finder_taxonomy`
--

INSERT INTO `jdev_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Vider la table avant d'insérer `jdev_finder_taxonomy_map`
--

TRUNCATE TABLE `jdev_finder_taxonomy_map`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_terms`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_terms` (
...
--
-- Vider la table avant d'insérer `jdev_finder_terms`
--

TRUNCATE TABLE `jdev_finder_terms`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Vider la table avant d'insérer `jdev_finder_terms_common`
--

TRUNCATE TABLE `jdev_finder_terms_common`;
--
-- Contenu de la table `jdev_finder_terms_common`
--

INSERT INTO `jdev_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Structure de la table `jdev_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Vider la table avant d'insérer `jdev_finder_tokens`
--

TRUNCATE TABLE `jdev_finder_tokens`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Vider la table avant d'insérer `jdev_finder_tokens_aggregate`
--

TRUNCATE TABLE `jdev_finder_tokens_aggregate`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_finder_types`
--

CREATE TABLE IF NOT EXISTS `jdev_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_finder_types`
--

TRUNCATE TABLE `jdev_finder_types`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_languages`
--

CREATE TABLE IF NOT EXISTS `jdev_languages` (
...
--
-- Vider la table avant d'insérer `jdev_languages`
--

TRUNCATE TABLE `jdev_languages`;
--
-- Contenu de la table `jdev_languages`
--

INSERT INTO `jdev_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Structure de la table `jdev_menu`
--

CREATE TABLE IF NOT EXISTS `jdev_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_menu`
--

TRUNCATE TABLE `jdev_menu`;
--
-- Contenu de la table `jdev_menu`
--

INSERT INTO `jdev_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'mainmenu', 'Our mission', 'our-mission', '', 'our-mission', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 43, 44, 0, '*', 0),
(103, 'mainmenu', 'The involded', 'the-involded', '', 'the-involded', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(104, 'mainmenu', 'Our Partners', 'our-partners', '', 'our-partners', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0),
(105, 'mainmenu', 'How can you help', 'how-can-you-help', '', 'how-can-you-help', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 49, 50, 0, '*', 0),
(106, 'mainmenu', 'News', 'news', '', 'news', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 0, '*', 0),
(107, 'mainmenu', 'Resources', 'resources', '', 'resources', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 53, 54, 0, '*', 0),
(108, 'mainmenu', 'About W°FAR', 'about-w-far', '', 'about-w-far', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0),
(109, 'mainmenu', 'Contact', 'contact', '', 'contact', 'index.php?option=com_contact&view=contact&id=1', 'component', 1, 1, 1, 8, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"presentation_style":"","show_contact_category":"","show_contact_list":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_links":"","linka_name":"","linkb_name":"","linkc_name":"","linkd_name":"","linke_name":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 57, 58, 0, '*', 0),
(110, 'leftmenu', 'Our mission', 'our-mission-left', '', 'our-mission-left', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"102","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 59, 60, 0, '*', 0),
(111, 'leftmenu', 'The involded', 'the-involded-left', '', 'the-involded-left', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"103","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 61, 62, 0, '*', 0),
(112, 'leftmenu', 'Our Partners', '2014-06-24-16-46-23', '', '2014-06-24-16-46-23', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"104","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 63, 64, 0, '*', 0),
(113, 'leftmenu', 'How can you help', '2014-06-24-16-46-52', '', '2014-06-24-16-46-52', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"105","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 65, 66, 0, '*', 0),
(114, 'leftmenu', 'News', '2014-06-24-16-47-21', '', '2014-06-24-16-47-21', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"106","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 67, 68, 0, '*', 0),
(115, 'leftmenu', 'Resources', '2014-06-24-16-48-22', '', '2014-06-24-16-48-22', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"107","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 69, 70, 0, '*', 0),
(116, 'leftmenu', 'About W°FAR', 'about-left', '', 'about-left', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"108","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 71, 72, 0, '*', 0),
(117, 'leftmenu', 'Contact', 'contact-left', '', 'contact-left', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"109","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 73, 74, 0, '*', 0);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_menu_types`
--

CREATE TABLE IF NOT EXISTS `jdev_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_menu_types`
--

TRUNCATE TABLE `jdev_menu_types`;
--
-- Contenu de la table `jdev_menu_types`
--

INSERT INTO `jdev_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Menu principal', 'Le menu principal du site'),
(2, 'leftmenu', 'Menu Left', 'Menu left');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_messages`
--

CREATE TABLE IF NOT EXISTS `jdev_messages` (
...
--
-- Vider la table avant d'insérer `jdev_messages`
--

TRUNCATE TABLE `jdev_messages`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `jdev_messages_cfg` (
...
--
-- Vider la table avant d'insérer `jdev_messages_cfg`
--

TRUNCATE TABLE `jdev_messages_cfg`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_modules`
--

CREATE TABLE IF NOT EXISTS `jdev_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_modules`
--

TRUNCATE TABLE `jdev_modules`;
--
-- Contenu de la table `jdev_modules`
--

INSERT INTO `jdev_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Menu principal', '', '', 1, 'wfar-topmenu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(87, 'Recherche', '', '', 1, 'wfar-search', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_search', 1, 0, '{"label":"","width":"20","text":"","button":"1","button_pos":"right","imagebutton":"","button_text":"","opensearch":"1","opensearch_title":"","set_itemid":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(88, 'Menu Left', '', '', 1, 'wfar-sidebar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"leftmenu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_modules_menu`
--

CREATE TABLE IF NOT EXISTS `jdev_modules_menu` (
...
--
-- Vider la table avant d'insérer `jdev_modules_menu`
--

TRUNCATE TABLE `jdev_modules_menu`;
--
-- Contenu de la table `jdev_modules_menu`
--

INSERT INTO `jdev_modules_menu` (`moduleid`, `menuid`) VALUES
(1, -101),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Structure de la table `jdev_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `jdev_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_newsfeeds`
--

TRUNCATE TABLE `jdev_newsfeeds`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_overrider`
--

CREATE TABLE IF NOT EXISTS `jdev_overrider` (
...
--
-- Vider la table avant d'insérer `jdev_overrider`
--

TRUNCATE TABLE `jdev_overrider`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_redirect_links`
--

CREATE TABLE IF NOT EXISTS `jdev_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_redirect_links`
--

TRUNCATE TABLE `jdev_redirect_links`;
--
-- Contenu de la table `jdev_redirect_links`
--

INSERT INTO `jdev_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://joomla.localhost/installation/index.php', '', 'http://joomla.localhost/installation/index.php', '', 41, 0, '2014-06-24 12:11:05', '0000-00-00 00:00:00'),
(2, 'http://joomla.localhost/', '', 'http://joomla.localhost/', '', 1, 0, '2014-06-24 16:17:37', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_schemas`
--

CREATE TABLE IF NOT EXISTS `jdev_schemas` (
...
--
-- Vider la table avant d'insérer `jdev_schemas`
--

TRUNCATE TABLE `jdev_schemas`;
--
-- Contenu de la table `jdev_schemas`
--

INSERT INTO `jdev_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.22');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_session`
--

CREATE TABLE IF NOT EXISTS `jdev_session` (
...
--
-- Vider la table avant d'insérer `jdev_session`
--

TRUNCATE TABLE `jdev_session`;
--
-- Contenu de la table `jdev_session`
--

INSERT INTO `jdev_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('1dv5i408ufvf88iov248ecqqk4', 1, 0, '1403628907', '__default|a:8:{s:15:"session.counter";i:208;s:19:"session.timer.start";i:1403626530;s:18:"session.timer.last";i:1403628904;s:17:"session.timer.now";i:1403628905;s:22:"session.client.browser";s:102:"Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.153 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":8:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":2:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"leftmenu";}s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":2:{s:4:"item";O:8:"stdClass":5:{s:2:"id";a:0:{}s:4:"data";N;s:4:"type";N;s:4:"link";N;s:8:"menutype";s:8:"leftmenu";}s:4:"menu";O:8:"stdClass":1:{s:4:"data";N;}}}s:11:"com_modules";O:8:"stdClass":4:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}s:9:"positions";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":4:{s:6:"search";s:0:"";s:5:"state";s:0:"";s:8:"template";s:4:"wfar";s:4:"type";s:0:"";}s:10:"limitstart";i:0;s:8:"ordercol";s:5:"value";s:9:"orderdirn";s:3:"asc";}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"leftmenu";}}s:14:"com_categories";O:8:"stdClass":2:{s:10:"categories";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:9:"extension";s:11:"com_contact";}}s:4:"edit";O:8:"stdClass":1:{s:8:"category";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}s:11:"com_contact";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"contact";O:8:"stdClass":1:{s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"455";s:4:"name";s:7:"Charles";s:8:"username";s:9:"charlesen";s:5:"email";s:20:"charles@charlesen.fr";s:8:"password";s:34:"$P$DgMGF6beO21RN2fYcbeUXjDeV6EIrE1";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-06-24 12:08:43";s:13:"lastvisitDate";s:19:"2014-06-24 12:31:29";s:10:"activation";s:1:"0";s:6:"params";s:92:"{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":6:{s:11:"admin_style";s:0:"";s:14:"admin_language";s:0:"";s:8:"language";s:0:"";s:6:"editor";s:0:"";s:8:"helpsite";s:0:"";s:8:"timezone";s:0:"";}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"1a14fb151de161588baa5caaac6b9b19";}', 455, 'charlesen', ''),
('af1641e393ffbf34a7a0c3ecd79a8cbd', 0, 1, '1403629138', '__default|a:8:{s:22:"session.client.browser";s:102:"Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.153 Safari/537.36";s:15:"session.counter";i:43;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:19:"session.timer.start";i:1403625559;s:18:"session.timer.last";i:1403629128;s:17:"session.timer.now";i:1403629137;s:13:"session.token";s:32:"c16fbd4485ccb1e13807b7902b6f1c54";}', 0, '', '');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_template_styles`
--

CREATE TABLE IF NOT EXISTS `jdev_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Vider la table avant d'insérer `jdev_template_styles`
--

TRUNCATE TABLE `jdev_template_styles`;
--
-- Contenu de la table `jdev_template_styles`
--

INSERT INTO `jdev_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
(7, 'wfar', 0, '1', 'W°FAR - Par défaut', '{}');

-- --------------------------------------------------------

--
-- Structure de la table `jdev_updates`
--

CREATE TABLE IF NOT EXISTS `jdev_updates` (
...
--
-- Vider la table avant d'insérer `jdev_updates`
--

TRUNCATE TABLE `jdev_updates`;
--
-- Contenu de la table `jdev_updates`
--

INSERT INTO `jdev_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(9, 3, 0, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/it-IT_details.xml', ''),
(10, 3, 0, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '2.5.20.1', '', 'http://update.joomla.org/language/details/es-ES_details.xml', ''),
(11, 3, 0, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/nl-NL_details.xml', ''),
...
(16, 3, 0, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/lv-LV_details.xml', ''),
...
(19, 3, 0, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/nl-BE_details.xml', ''),
(20, 3, 0, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '2.5.20.1', '', 'http://update.joomla.org/language/details/mk-MK_details.xml', ''),
(21, 3, 0, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/ja-JP_details.xml', ''),
(22, 3, 0, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '2.5.20.1', '', 'http://update.joomla.org/language/details/sr-YU_details.xml', ''),
(23, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.21.1', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(24, 3, 0, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/de-DE_details.xml', ''),
...
(31, 3, 0, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/cs-CZ_details.xml', ''),
...
(34, 3, 0, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '2.5.22.1', '', 'http://update.joomla.org/language/details/pl-PL_details.xml', ''),
...
--
-- Structure de la table `jdev_update_categories`
--

CREATE TABLE IF NOT EXISTS `jdev_update_categories` (
...
--
-- Vider la table avant d'insérer `jdev_update_categories`
--

TRUNCATE TABLE `jdev_update_categories`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_update_sites`
--

CREATE TABLE IF NOT EXISTS `jdev_update_sites` (
...
--
-- Vider la table avant d'insérer `jdev_update_sites`
--

TRUNCATE TABLE `jdev_update_sites`;
--
-- Contenu de la table `jdev_update_sites`
--

INSERT INTO `jdev_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1403626574),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1403626574),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1403626574);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `jdev_update_sites_extensions` (
...
--
-- Vider la table avant d'insérer `jdev_update_sites_extensions`
--

TRUNCATE TABLE `jdev_update_sites_extensions`;
--
-- Contenu de la table `jdev_update_sites_extensions`
--

INSERT INTO `jdev_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 602);
...
--
-- Structure de la table `jdev_usergroups`
--

CREATE TABLE IF NOT EXISTS `jdev_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Vider la table avant d'insérer `jdev_usergroups`
--

TRUNCATE TABLE `jdev_usergroups`;
--
-- Contenu de la table `jdev_usergroups`
--

INSERT INTO `jdev_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Enregistré'),
(3, 2, 7, 14, 'Auteur'),
(4, 3, 8, 11, 'Rédacteur'),
...
--
-- Structure de la table `jdev_users`
--

CREATE TABLE IF NOT EXISTS `jdev_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Vider la table avant d'insérer `jdev_users`
--

TRUNCATE TABLE `jdev_users`;
--
-- Contenu de la table `jdev_users`
--

INSERT INTO `jdev_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(455, 'Charles', 'charlesen', 'charles@charlesen.fr', '$P$DgMGF6beO21RN2fYcbeUXjDeV6EIrE1', 'deprecated', 0, 1, '2014-06-24 12:08:43', '2014-06-24 16:16:05', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_user_notes`
--

CREATE TABLE IF NOT EXISTS `jdev_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Vider la table avant d'insérer `jdev_user_notes`
--

TRUNCATE TABLE `jdev_user_notes`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_user_profiles`
--

CREATE TABLE IF NOT EXISTS `jdev_user_profiles` (
...
--
-- Vider la table avant d'insérer `jdev_user_profiles`
--

TRUNCATE TABLE `jdev_user_profiles`;
-- --------------------------------------------------------

--
-- Structure de la table `jdev_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `jdev_user_usergroup_map` (
...
--
-- Vider la table avant d'insérer `jdev_user_usergroup_map`
--

TRUNCATE TABLE `jdev_user_usergroup_map`;
--
-- Contenu de la table `jdev_user_usergroup_map`
--

INSERT INTO `jdev_user_usergroup_map` (`user_id`, `group_id`) VALUES
(455, 8);

-- --------------------------------------------------------

--
-- Structure de la table `jdev_viewlevels`
--

CREATE TABLE IF NOT EXISTS `jdev_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Vider la table avant d'insérer `jdev_viewlevels`
--

TRUNCATE TABLE `jdev_viewlevels`;
--
-- Contenu de la table `jdev_viewlevels`
--

INSERT INTO `jdev_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Accès Public', 0, '[1]'),
...
--
-- Structure de la table `jdev_weblinks`
--

CREATE TABLE IF NOT EXISTS `jdev_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Vider la table avant d'insérer `jdev_weblinks`
--

TRUNCATE TABLE `jdev_weblinks`;
